...
//      Não consegui fazer o exercício.
...
//         a) Crie um novo array que contenha apenas o nome dos doguinhos
        ...
        //    { nome: "Caramelo", raca: "Vira-lata"},
        // ]
        // function retornaNome(cachorro){
        //     return cachorro.nome
        // }

        // const nomesCachorro = pets.map(retornaNome)
        // console.log("nomesCachorro", nomesCachorro)
...
const pets = [
    ...
    const salsicha = (array) =>{
        return array.includes("Salsicha")
    } 

        const salsichaViva = pets.filter(salsicha)
        console.log(salsichaViva)


        // for(let raca of pets )
        //     if("Salsicha" === pets)
        //         raca = pets
        // console.log(raca)

//  function retornaRaca(cachorro){
//      return cachorro.raca
//  }

//  const racaCachorro = pets.filter(retornaRaca)
//  console.log("racaCachorro", racaCachorro)
