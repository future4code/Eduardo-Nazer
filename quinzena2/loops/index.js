...
//         console.log(valor)
//         ```
    //O código está somando a variável "valor" com "i" em looping, enquanto o valor for menor que cinco o código não vai sair do looping.
...
//         b) Se eu quisesse acessar o **índice** de cada elemento dessa lista, o `for...of...` é suficiente? Se não, o que poderia ser usado para fazer isso?
    ...
    //Não é o suficiente, teria que utilizar o comando dessa forma: 
